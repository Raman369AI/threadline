...
| Git changes | Changed definitions, known callers, possible impact, added/deleted files | Diff mapping is syntactic and uses retained source. Rename, quoted-path, and concurrent-edit cases have regression coverage. |
